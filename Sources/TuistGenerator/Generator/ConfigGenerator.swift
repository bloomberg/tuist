...
final class ConfigGenerator: ConfigGenerating {
    ...
    func generateManifestsConfig(pbxproj: PBXProj,
        ...
        let addSettings: (XCBuildConfiguration) throws -> Void = { configuration in
            let productsDirectoryPath = try resourceLocator.productsDirectoryPath()
            configuration.buildSettings["FRAMEWORK_SEARCH_PATHS"] = productsDirectoryPath.asString
            configuration.buildSettings["LIBRARY_SEARCH_PATHS"] = productsDirectoryPath.asString
            ...
            configuration.buildSettings["SWIFT_INCLUDE_PATHS"] = productsDirectoryPath.asString
            ...
            configuration.buildSettings["OTHER_SWIFT_FLAGS"] = "-swift-version 4 -I \(productsDirectoryPath.asString)"
        }
